...
public class PullToZoomGLV extends GroupListView implements
	...
	public PullToZoomGLV(Context context, AttributeSet attrs) {
		super(context,attrs);
		init(context);
	}
		...
		public void run() {
			...
			if ((!this.mIsFinished) && (this.mScale > 1.0D)) {
				...
				f2 = this.mScale - (this.mScale - 1.0F)
						* PullToZoomGLV.sInterpolator.getInterpolation(f1);
				localLayoutParams = PullToZoomGLV.this.mHeaderContainer
						.getLayoutParams();
				if (f2 > 1.0F) {
//					Log.d("mmm", "f2>1.0");
					localLayoutParams.height = PullToZoomGLV.this.mHeaderHeight;
					localLayoutParams.height = ((int) (f2 * PullToZoomGLV.this.mHeaderHeight));
					PullToZoomGLV.this.mHeaderContainer
							.setLayoutParams(localLayoutParams);
					PullToZoomGLV.this.post(this);
					return;
				}
				this.mIsFinished = true;
			}
		...
		public void startAnimation(long paramLong) {
			...
			this.mScale = ((float) (PullToZoomGLV.this.mHeaderContainer
					.getBottom()) / PullToZoomGLV.this.mHeaderHeight);
